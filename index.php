...
define("clientID"  ,	 '3cb2bc24875f43999d724a3bf93b7e0c'); 			//associated your developer account with this program
define("clientSecret"  ,	 'dfb66bcd929c412abdce2f8ad32ff7a9'); 			//password
define("redirectURI" ,	 'http://wasifshikder.com/imageDownloader/index.php' ); 		//after users choose whether to let you use access account or not (must match the one you registered)
